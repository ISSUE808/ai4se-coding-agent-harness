...
export interface SessionStore {
   ...
   * @param model session-level model override (Task 26); undefined = follow
   *   the config default.
   */
  create(task: string, maxRounds?: number, workspaceRoot?: string, model?: string): Session;
  ...
  /**
   * Set (or clear with `null`) the session-level model override (Task 26);
   * returns the updated session or null when unknown.
   */
  updateModel(id: string, model: string | null): Session | null;
  /**
